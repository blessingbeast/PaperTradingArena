    ...
    if (success) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-gray-900 to-black p-4">
                <Card className="w-full max-w-md bg-white/10 dark:bg-black/30 backdrop-blur-xl border-white/10 text-white">
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-gray-900 to-black p-4 relative overflow-hidden">
            ...
            <Card className="w-full max-w-md bg-white/10 dark:bg-black/30 backdrop-blur-xl border-white/10 dark:border-white/5 shadow-2xl">
                <CardHeader className="text-center space-y-2 pb-6">
                    ...
                    <p className="text-sm text-gray-400">Start your paper trading journey</p>
                </CardHeader>
